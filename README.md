...
```shell
venv/bin/python src/borat.py --input="/videos/stuff.webm" --fontsize=3.3 --fps=1.5 --width=600 --words="I want to eat ;; [Random] ; [repeat] ;" --format=mp4 --bgcolor=0,0,0 --no-baseline --output="stuff/videos"
```
