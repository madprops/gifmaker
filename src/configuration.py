...
class Configuration:
	...
	def parse_args(self) -> None:
		...
		p.add_argument("--delay", type=Any, help="The delay in ms between frames")
		...
		p.add_argument("--opacity", type=Any, help="The opacity of the background rectangle")
		p.add_argument("--padding", type=Any, help="The padding of the background rectangle")
		p.add_argument("--radius", type=Any, help="The border radius of the background")
